        ...
        if ("undefined" === typeof(__da_info_loaded)) {
            ...
            newScript.src =  "http://st.drivenetwork.ru/news/js/info.min.js?t=1521463232";
            document.getElementsByTagName("head")[0].appendChild(newScript);
            __da_info_loaded = 1;
        }
    if(document.getElementById('DIV_DN_35_192')) { 
            ...
            __da_widget_count++;
                ...
                (function () {
                    var __da_widget_src = '//www.drivenetwork.ru/data/35.js?nnn=35&div=DIV_DN_35_192&async=1&t=0.484366662400699';

                    var newScript = document.createElement('script');
                    newScript.type = 'text/javascript';
                    newScript.charset = 'windows-1251';
                    newScript.src = __da_widget_src;
