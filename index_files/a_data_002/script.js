...
var ar_back = '12321.gif',	// имя фонового изображения. Впишите ваше имя файла. Если изображение должно загружаться со стороннего сервера, впишите полный адрес, начинающийся с «http://». В этом случае, загружать его не придется.
    ar_back_color = '#ffffff',		// цвет, которым заполняется место, вокруг фонового изображения. Указывайте цвет в виде rgb: #rrggbb. Если не нужен, оставьте пустым.
